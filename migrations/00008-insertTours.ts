...
export const tours = [
  {
    ...
    imageUrl: '/images/tours/ethiopia.jpeg',
  },
  {
    id: 2,
    userId: 2,
    ...
    imageUrl: '/images/tours/morocco.jpeg',
  },
  {
    id: 3,
    userId: 1,
    ...
    imageUrl: '/images/tours/india.jpeg',
  },
  {
    id: 4,
    userId: 3,
    ...
    imageUrl: '/images/tours/brazil.jpeg',
  },
  {
    id: 5,
    userId: 4,
    ...
    imageUrl: '/images/tours/peru.jpeg',
  },
  {
    id: 6,
    userId: 1,
    ...
    imageUrl: '/images/tours/oaxaca.jpeg',
  },
  {
    id: 7,
    userId: 1,
    ...
    imageUrl: '/images/tours/hawaii.jpeg',
  },
  {
    id: 8,
    userId: 1,
    ...
    imageUrl: '/images/tours/seychelles.jpeg',
  },
  {
    id: 9,
    userId: 3,
    ...
    imageUrl: '/images/tours/philippines.jpeg',
  },
  {
    id: 10,
    userId: 1,
    ...
    imageUrl: '/images/tours/iceland.jpeg',
  },
  {
    id: 11,
    userId: 3,
    ...
    imageUrl: '/images/tours/kenya.jpeg',
  },
  {
    id: 12,
    userId: 4,
    ...
    imageUrl: '/images/tours/nepal.jpeg',
  },
];
...
export async function up(sql: Sql) {
  for (const tour of tours) {
    ...
    VALUES
      (${tour.name}, ${tour.userId}, ${tour.blogId}, ${tour.blogName}, ${tour.category}, ${tour.location}, ${tour.description}, ${tour.imageUrl})
  `;
  }
}
...
export async function down(sql: Sql) {
  for (const tour of tours) {
    await sql`
      DELETE FROM tours WHERE id = ${tour.id}
  `;
  }
}
